...
#### normalization ####
#### normalization ####
otu_common_combine_normalized<-normalization_f(otu_common_combine)

data_for_PCoA<-otu_common_combine_normalized
...
print(p_plot)
tiff(paste0('PCoA main',".tif"), height=1400, width=1400, res=250, units="px"); print(p_plot); dev.off()

save.image(file='Main dataset 4 data for PCoA.RData')
